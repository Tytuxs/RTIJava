...
public class ClientHandlerAdmin extends Thread {
    ...
    public ClientHandlerAdmin(ServerSocket ss, ArrayList<ClientHandlerUrgence> liste, ArrayList<ClientHandlerPaiement> liste2, BD_Bean BP, ArrayList<Socket> listS) {
        this.ssAdmin = ss;
