...
public class TachesUrgente implements SourceTaches {
    ...
    public synchronized void recordTache(Socket s) {
        listeTaches.add(s);
        System.out.println("PAIEMENT URGENT : ListeTaches : tache dans la file");
        notify();
    }
}
